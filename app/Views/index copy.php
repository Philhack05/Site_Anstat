                ...
                <form action="<?= route_to('store.questionnaire'); ?>" method="post" id="regForm" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <select class="custom-select form-control" id="B4_1" name="B4_1" required>
                                            <option value="">--Choisir--</option> 
                                             <?php foreach ($sousPrefectures as $sousPrefecture) : ?>
                                                <option value="<?= esc($sousPrefecture['cod_sp']); ?>"><?= esc($sousPrefecture['nom_sp']); ?></option>
                                            <?php endforeach; ?> 
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="tab step-tab" id="section12">
                        ...
                        <div class="text-center mt-4">
                             <button type="button" id="downloadPDF" class="btn btn-warning">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js"></script>
        ...
        <script>
            ...
            document.querySelectorAll('.ordre-check').forEach(checkbox => {
                checkbox.addEventListener('change', function () {
                    ...
                    console.log('Ordre de sélection :', selectedOrder); 
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function mettreAJourChamps(position) {
            ...
            console.log("Champs mis à jour :", longitude, latitude, accuracy);
        }
    });
</script>
    ...
    $(document).ready(function() {
        ...
        <script>
               ...
               function toggleVisibility(condition, elementId) {
                ...
                function updateVisibility() {
                    ...
                    toggleVisibility(C12bVal === '37', 'C12b_37');
        ...
        <script>
            ...
            document.getElementById("regForm").addEventListener("submit", function (e) {
                ...
                let formData = getVisibleFormData("regForm");
                ...
                function getVisibleFormValues(formId) {
                    const form = document.getElementById(formId);
                    const data = {};

                    form.querySelectorAll("input, select, textarea").forEach(el => {
                        // Vérifie que l'élément est visible et pas disabled
                        if (el.offsetParent !== null && !el.disabled) {
                            if (el.type === "checkbox") {
                                data[el.name] = el.checked ? "Oui" : "Non";
                ...
                function generatePDF(formId) {
                    const values = getVisibleFormValues(formId);
                    const doc = new jsPDF();
